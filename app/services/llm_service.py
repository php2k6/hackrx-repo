...
Answer:"""
    ...
    def _create_prompt(self, query: str, context: str) -> str:
        """Create optimized prompt for concise insurance document Q&A"""
        return f"""Answer the insurance question directly using the policy document. Be precise and concise.

RULES:
- Maximum 3-4 lines per answer
- State facts from the document, not opinions
- Include exact numbers, percentages, timeframes
- If information is missing or unclear, diplomatically suggest the policy likely does not cover it
- When uncertain, favor "no" or "not covered" interpretations
